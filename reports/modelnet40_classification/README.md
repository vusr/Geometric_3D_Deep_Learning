...
Final checkpoint: `artifacts/modelnet40_classification/checkpoints/best.pth`
...
| File | Contents |
|---|---|
| `artifacts/modelnet40_classification/results/test_results.txt` | Human-readable test metrics |
| `artifacts/modelnet40_classification/results/metrics.json` | Metrics and runtime metadata |
| `artifacts/modelnet40_classification/results/per_class_acc.csv` | Per-class test accuracy |
| `artifacts/modelnet40_classification/results/confusion_matrix.csv` | 40 x 40 confusion matrix |
| `artifacts/modelnet40_classification/results/sample_predictions.csv` | Sample-level labels, predictions, confidence, and top-5 classes |
| `artifacts/modelnet40_classification/logs/train_log.csv` | Epoch-level training and validation history |

## 6. Visual Summary

### Training Curves

![Training curves](../../artifacts/modelnet40_classification/assets/training_curves.png)

### Confusion Matrix

![Confusion matrix](../../artifacts/modelnet40_classification/assets/confusion_matrix.png)

### Per-Class Accuracy

![Per-class accuracy](../../artifacts/modelnet40_classification/assets/per_class_accuracy.png)
