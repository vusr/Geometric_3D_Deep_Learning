...
def main():
    ...
    checkpoint = Path(args.checkpoint) if args.checkpoint else run_dir / "checkpoints" / "shapenetsem_regression" / "global" / "best.pth"
    results_dir = Path(args.results_dir) if args.results_dir else run_dir / "results" / "shapenetsem_regression" / "global"
