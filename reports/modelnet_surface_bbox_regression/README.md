...
`checkpoints/modelnet_surface_bbox_reg/global/epoch_010.pth`
...
| File | Contents |
|---|---|
| `data/modelnet_surface_bbox/analysis_summary.json` | Outlier and cluster decision summary |
| `data/modelnet_surface_bbox/outliers_removed.csv` | Samples removed by robust fences |
| `data/modelnet_surface_bbox/norm_stats.json` | Input and target normalization statistics |
| `data/modelnet_surface_bbox/splits.csv` | Final train/val/test manifest with retained cluster assignment |

### Target Scatter

![Retained target scatter](../../data/modelnet_surface_bbox/analysis_plots/target_scatter_retained.png)

### Target Distributions

![Surface area log histogram](../../data/modelnet_surface_bbox/analysis_plots/surface_area_log_hist.png)

![Bounding-box volume log histogram](../../data/modelnet_surface_bbox/analysis_plots/bbox_volume_log_hist.png)
...
| File | Contents |
|---|---|
| `results/modelnet_surface_bbox_reg/global/reg_test_results.txt` | Human-readable test metrics |
| `results/modelnet_surface_bbox_reg/global/reg_predictions.csv` | Sample-level true and predicted targets |
| `logs/modelnet_surface_bbox_reg/global/train_log.csv` | Epoch-level training and validation history |
| `checkpoints/modelnet_surface_bbox_reg/global/epoch_010.pth` | Final evaluated model checkpoint |

## 7. Visual Summary

![Regression prediction gallery](../../assets/modelnet_regression/sample_regression_prediction_gallery.png)

Green borders indicate average relative target error at or below 50%. Red borders
indicate larger average relative error.
