...
|---|---|---|---|---:|---|
| ModelNet40 classification | ModelNet40 | 40-class object classification | PointNet++ MSG | 87.12% top-1 accuracy | [report](reports/modelnet_classification/README.md) |
| ModelNet40 regression | ModelNet40 | surface area + bounding-box volume | PointNet++ MSG | 0.5851 mean R2 | [report](reports/modelnet_surface_bbox_regression/README.md) |
...
checkpoint at `checkpoints/cls/best.pth`. Full metrics, training curves,
confusion matrix, and per-class accuracy are available in
[reports/modelnet_classification/README.md](reports/modelnet_classification/README.md).
...
`checkpoints/modelnet_surface_bbox_reg/global/epoch_010.pth`. Full metrics,
outlier analysis, and training details are available in
[reports/modelnet_surface_bbox_regression/README.md](reports/modelnet_surface_bbox_regression/README.md).
...
`checkpoints/shapenetsem_regression/global/best.pth`. Full target metrics,
outlier analysis, and training details are available in
...
The final evaluation used the checkpoint at
`checkpoints/shapenetsem_weight/auxiliary/best.pth`. Full metrics, material-prior
...
```bash
python scripts/create_prediction_gif_assets.py \
  --run_dir ~/geometric_deep_learning \
  --data_dir ~/geometric_deep_learning/data
```
