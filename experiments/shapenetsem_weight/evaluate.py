...
from gdl.engine import collate_aux_batch as collate_fn, points_to_pyg
from gdl.datasets.shapenetsem_weight import ShapeNetSemWeightDataset
from gdl.models.pointnet2_aux_reg import PointNet2AuxRegression
from gdl.utils.metrics import regression_metrics
...
def main():
    ...
    checkpoint = Path(args.checkpoint) if args.checkpoint else run_dir / "artifacts" / "shapenetsem_weight" / "checkpoints" / "auxiliary" / "best.pth"
    results_dir = Path(args.results_dir) if args.results_dir else run_dir / "artifacts" / "shapenetsem_weight" / "results" / "auxiliary"
